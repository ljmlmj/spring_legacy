...
public class BoardController {
	...
	public String getBoardById(@RequestParam("no") int no, Model model){
		...
		Board vo = new Board();
		vo.setNo(no);
		Board boardVo = boardService.getBoardById(vo);
	...
	public String insertBoard(Board vo, Model model) throws IOException{  // 수정
	...
	public String updateBoardForm(Board vo, Model model){
	...
	public String boardModify(Board vo, Model model){
