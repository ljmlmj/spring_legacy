...
//	private BoardService boardService;
	...
	private BoardServiceImpl service;		//DI (디펜더시, 인젝션)		//모든 스프링 컨테이너를 뒤져서 Bean이 있으면 Bean을 넣어줌
	...
	public String boardWrite(BoardVo vo, Model model) throws Exception{						// BoardVo vo
