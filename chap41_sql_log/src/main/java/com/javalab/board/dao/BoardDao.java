...
//@Repository만 어노테이션을 썻을 경우 boardDao 라는 이름으로 빈으로 등록된다.
//@Repository("dao") 어노테이션을 썻을 경우 dao 라는 이름으로 빈으로 등록된다.
...
//         String query = "insert into simple_board(no, title, content, writer) values(seq_simple_board.nextval, ?, ?, ?)";
         String query = "insert into simple_board(no, title, content, writer) values(?, ?, ?, ?)";
