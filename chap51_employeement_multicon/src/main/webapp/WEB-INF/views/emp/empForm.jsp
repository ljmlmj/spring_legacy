                    	...
                    	<div>
 							<form id="registerForm" action="<c:url value="/emp/register.do" />" 
			                    ...
			                    <div class="form-group">
			                        ...
			                        <input type="date" name="hireDate" id="hireDate"  value="${empMap.hireDate}" maxlength="20" size="25" >
			                        
			                    </div>
			                    <div class="form-group">
			                        <label for="jobId">jobId(데이터베이스 있는 jobid)</label>
					            	<select class="form-control" name="jobId" id="jobId" >
										<c:forEach var="job" items="${empMap.jobList}">
			                    ...
			                    <div class="form-group">
			            			...
			            			<select class="form-control" name="departmentId" id="departmentId" >
										<c:forEach var="department" items="${empMap.departmentList}">
