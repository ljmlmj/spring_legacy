                ...
                <div>
                    <table class="table table-bordered table-hover table-striped" >
                        ...
                        <tr>
							...
							<input type="button" id="btnModify" class='btn btn-info' onclick="location.href='<c:url value="/emp/modify.do" />'" value="수정" />
	                        <input type="button" id="btnList" class='btn btn-info' onclick="location.href='<c:url value="/emp/list.do" />'" value="목록" />							
							<input type="button" id="btnDelete" class='btn btn-info' onclick="location.href='<c:url value="/emp/delete.do" />'" value="삭제" />
							</td>
