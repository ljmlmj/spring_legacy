                    ...
                    <div class="panel-body">
            			<!-- start search -->	
		 				<div class='row' style="text-align: center; margin-bottom:10px;">
							<div class="col-lg-12">
								<form id='searchForm' action="<c:url value="/emp/list.do" />" method='get'>
									<div class="form-group">
						                ...
						                <div class="col-md-6" style="text-align: left;">
						                    ...
						                    <input type="button" class='btn btn-warning' onclick="location.href='<c:url value="/emp/list.do" />'" value="전체보기" />
						                    <input type="button" class='btn btn-success' value="사원등록" onclick="location.href='<c:url value="/emp/register.do" />'" />
						                </div>
						            </div>
								</form>   
		 					</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".paginate_button a").on("click",	function(e) {
				...
				actionForm.attr("action", "${pageContext.request.contextPath}/emp/list.do");
				actionForm.submit();
			});
